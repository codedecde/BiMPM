...
class BiMpm(Model):
    ...
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'BiMpm':
        ...
        matcher_word = BiMpmMatching.from_params(params.pop("matcher_word"))
        encoder1 = Seq2SeqEncoder.from_params(params.pop("encoder1"))
        matcher_forward1 = BiMpmMatching.from_params(params.pop("matcher_forward1"))
        matcher_backward1 = BiMpmMatching.from_params(params.pop("matcher_backward1"))
        encoder2 = Seq2SeqEncoder.from_params(params.pop("encoder2"))
        matcher_forward2 = BiMpmMatching.from_params(params.pop("matcher_forward2"))
        matcher_backward2 = BiMpmMatching.from_params(params.pop("matcher_backward2"))
